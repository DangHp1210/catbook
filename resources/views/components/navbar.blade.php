...
<style>
    ...
    .cb-nav-links a:hover { color: var(--cb-brand-text); }
    .cb-nav-links a.active { color: var(--cb-brand-accent); }
    ...
    .cb-mobile-link--cta:hover { background: var(--cb-brand-accent-dark); color: #fff; }
